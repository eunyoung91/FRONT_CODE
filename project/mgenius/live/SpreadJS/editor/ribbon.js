    ...
    Ribbon.prototype.create = function () {
        ...
        function createTabs(options) {
            var selected = options.selected,
                $ul = $('<ul class="nav nav-tabs" style="display:none;" ></ul>');
        ...
        function createTabItems(options) {
            ...
            var $div = $('<div class="tab-content" style="border:none !important;border-top:1px solid #ddd !important;border-right:1px solid #ddd !important;border-left:1px solid #ddd !important;"></div>');
