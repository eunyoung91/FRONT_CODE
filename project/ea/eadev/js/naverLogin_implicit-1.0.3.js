 ...
 */
	this.init_naver_id_login = function ()
	{
		...
		{
			naver_id_login_contents="<span class='txt'>네이버 아이디로 편리하게 로그인 할 수 있습니다.</span><a class='btn' href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src='http://img.eduwill.net/Img2/Common/Join/new/btn_naver01.png' alt='네이버로 로그인'></a> ";
		}
		else if (this.button_type == 11)
		{
			naver_id_login_contents="<span class='txt'>네이버 아이디로 편리하게 로그인 할 수 있습니다.</span><a class='btn' href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src='http://img.eduwill.net/Img2/mobile2/brand_new/common/btn_naver01.png' alt='네이버로 로그인'></a> ";
		}
