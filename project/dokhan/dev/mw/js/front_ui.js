...
$(function(){
	...
	//20180627 추가
	$('.js_toggle2 li a').click ( function(){
		$(this).parent().addClass('open').find('.detail').toggle().parent().siblings('li').removeClass('open').find('.detail').hide();
		return false;
	})
	...
	*/
	...
	//layer close
	$(document).on('click','.layer_wrap .close', function(){
