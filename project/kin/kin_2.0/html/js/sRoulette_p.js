...
var Sroulette = (function(){
    ...
    function Sroulette(id, option, imgSetting) {
        ...
        this.urlRoot = 'http://img.eduwill.net/resources/kin/dev/images/promotion/month2001_kin/pc/';
        var rouletteSelector = this.roulette;
        var imgRoot = this.urlRoot;

        $(this.btnId).on('click', function () {
            rouletteSelector.attr('src', imgRoot+'img_roulette_knight.png');
            //rouletteSelector.attr('src', 'roulette.png');
    ...
    Sroulette.prototype.endAnimate = function (deg) {
        ...
        if(part >= this.rouletteNum){
            ...
            alert("당첨내역:" + rouletteVal[rouletteVal.length-1]);
            this.imgSet();
           return;
        }
        this.part = part;
        console.log("당첨내역:" + rouletteVal[part] + ", 상품범위:" + part);
        alert("당첨내역:" + rouletteVal[part]);
        this.imgSet();
    };
