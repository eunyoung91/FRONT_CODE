...
function addEvent(){
	...
	// 내정보 탭
	$(".page-tab-list li").children("a").on("click", function(){
		var idx = $(this).parent("li").index();

		$(".page-tab-list li").children("a").removeClass("active");
		$(this).addClass("active");

		$(".page-tab-view").hide();
		$(".page-tab-view").eq(idx).show();
	});

	// 결제 영역
	$(".payment-info .info-pay").find("label").on("click", function(){
		$(".payment-info .info-pay label").removeClass('active');
		$(this).addClass('active');
	});
