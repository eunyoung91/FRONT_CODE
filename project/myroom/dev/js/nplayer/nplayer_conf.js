var NPLAYER_VERSION = "2,0,322,3826";
//var NPLAYER_VERSION = "2,0,349";
var NPLAYER_SETUP_URL = "http://dist.cdnetworks.co.kr/cdndist/aquanplayer/AquaNPlayer_2.0.322.3826_1026_proxy_1.0.0.27.exe";
var NPLAYER_OSX_SETUP_URL = "http://dist.cdnetworks.co.kr/cdndist/aquanplayer/AquaNAgent_1.0.0.36.dmg";
var AX_VERSION = "1,0,2,5";
var PROXY_WIN_VERSION = "1,0,0,26";
...
var NPLAYER_INSTALL_MSG= "<a href='"+NPLAYER_SETUP_URL+"'><img src='//img.eduwill.net/resources/myroom/library/images/nplayer/download.png' border='0' /></a><p>동영상을 시청하려면 <span style='color:#00ff00'>AquaNPlayer</span> 를 설치하여 주십시오.</p><p>설치에 문제가 있으면 <a style='color:#ff4f4f;text-decoration:none' href='"+NPLAYER_SETUP_URL+"'>수동 설치 프로그램을 내려받아</a> 설치하여 주십시오.</p>";
...
var STR_PPROXY_ERROR_BLOCKED_HTTP= "재생 정보가 차단되었습니다.";
var STR_PROXY_ERROR_ACTIVE_NOT_CLEARED= "재생 정보가 존재하여 미디어 요청이 취소되었습니다.";
