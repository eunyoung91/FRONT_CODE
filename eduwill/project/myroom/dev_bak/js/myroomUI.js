...
function writeLayer2(){
	...
	str +='					<li><a href="http://jr.eduwill.net/" target="_blank" title="새 창 열림">서울종로</a></li> ';
	...
	str +='					<li><a href="http://sn.eduwill.net/" target="_blank" title="새 창 열림">경기성남</a></li> ';
	str +='					<li><a href="http://pc.eduwill.net/" target="_blank" title="새 창 열림">경기평촌</a></li> ';
	str +='					<li><a href="http://dj.eduwill.net/" target="_blank" title="새 창 열림">대전</a></li> ';
	str +='					<li><a href="http://sm.eduwill.net/" target="_blank" title="새 창 열림">부산서면</a></li> ';
	str +='					<li><a href="http://hu.eduwill.net/" target="_blank" title="새 창 열림">부산해운대</a></li> ';
	str +='					<li><a href="javascript:;">서울신림 (10월오픈)</a></li> ';
	str +='					<li><a href="javascript:;">경기일산 (8월오픈)</a></li> ';
	str +='					<li><a href="javascript:;">광주 (8월오픈)</a></li> ';
	str +='					<li><a href="javascript:;">대구 (8월오픈)</a></li> ';
	str +='				</ul> ';
	str +='			</dd> ';
