...
<div id="wrapper"> 
    ...
    <div id="container" style="padding-bottom:0px !important;">
       ...
       <%If CDbl(GetNowDate()) < CDbl("2023"&"0107"&"140000") Then%> <!--2023-01-06 / 최민석 / 재수 우선선발반 우측 스카이배너 비게시-->
            <ul class="quick">
                <li><a href="https://campus.megastudy.net/common/notice/fair_view.asp?code=21794" target="_blank"><img src="<%=Application("img_path")%>/library/campus_common/2024/2024_nsufirst_gate/quick_top.png" alt="우선선발반 설명회"></a></li>
                ...
                <div class="top_wrap">
                    ...
                    <div class="video_area">
                        <div class="video_content">
                            <iframe src='https://tv.naver.com/embed/31202200?autoPlay=true' frameborder='no' scrolling='no' marginwidth='0' marginheight='0' WIDTH='1000' HEIGHT='562' allow='autoplay' allowfullscreen></iframe>
				...
				<div class="div_con5" id="link">
                    ...
                    <div class="con taC"> 
                        <ul>   
                            ...
                            <li id="C14" class="cam_list"><a href="https://ansung.megastudy.net/ansung/nsu/2023/2024_nsufirst/nsufirst_01.asp" target="_blank">
                                <div class="flag ver01">
                                    <span>신규 개원</span>
                                </div>
						...
						<ul>
                            ...
                            <li id="C03" class="cam_list"><a href="https://gangnam.megastudy.net/gangnam/nsu/main.asp" target="_blank">
                            ...
                            <a href="https://gangbuk.megastudy.net/gangbuk/nsu/nsu/2023/2024_nsufirst/nsufirst_01.asp" target="_blank" >
                                <!-- <div class="flag ver01">
                                    <span>전반<br>마감</span>
                                </div> -->
							...
							<li id="C04" class="cam_list"><a href="https://noryangjin.megastudy.net/noryangjin/nsu/nsu/2023/2024_nsufirst/nsufirst_01.asp" target="_blank">
                                <!--
                                <div class="flag ver01">
                                    <span>마감임박</span>
                                </div>-->
						...
						<ul>
                            <li id="C11" class="cam_list"><a href="https://sinchon.megastudy.net/sinchon/main.asp?refer=" target="_blank" >
							...
							<li id="C06" class="cam_list">
								...
								<a href="https://songpa.megastudy.net/songpa/nsu/main.asp?refer=" target="_blank">
						...
						<ul>
							...
							<li id="C10" class="cam_list">
								<a href="https://pyeongchon.megastudy.net/pyeongchon/nsu/nsu/2023/2024_nsufirst/nsufirst_01.asp" target="_blank" >
									<!-- <div class="flag ver01">
										<span>전반마감</span>
									</div> -->
