...
.fix_bottom_area ul li a {font-size:16px; color:#fff; font-weight:500; line-height:40px; position:relative; display:block;}
...
.fix_bottom_wrap.inner {position:absolute; top:740px; z-index:1; width:1000px;max-width:1000px;height:190px;left:50%; margin-left:-500px;box-sizing:border-box;z-index:10;}
...
.fix_bottom_wrap.inner .fix_bottom_area ul.large {width:740px; float:left;}
.fix_bottom_wrap.inner .fix_bottom_area ul li {width:130px;margin-top:10px;box-sizing:border-box;}
.fix_bottom_wrap.inner .fix_bottom_area ul.large li:nth-child(2) {width:180px !important; margin-left:0 !important;}
.fix_bottom_wrap.inner .fix_bottom_area ul.large li:nth-child(3) {position:absolute; left:30px; bottom:20px; width:180px !important; margin-left:0 !important;}
.fix_bottom_wrap.inner .fix_bottom_area ul.large li:nth-child(5) {position:absolute; left:210px; bottom:72px; }
.fix_bottom_wrap.inner .fix_bottom_area ul.large li:nth-child(6) {position:absolute; left:210px; bottom:20px; }
.fix_bottom_wrap.inner .fix_bottom_area ul.large li:nth-child(7) {position:absolute; left:349px; bottom:72px; }
.fix_bottom_wrap.inner .fix_bottom_area ul.large li:nth-child(8) {position:absolute; left:349px; bottom:20px; }
.fix_bottom_wrap.inner .fix_bottom_area ul.large li:nth-child(9) {position:absolute; left:489px; bottom:72px; }
.fix_bottom_wrap.inner .fix_bottom_area ul.large li:nth-child(10) {position:absolute; left:489px; bottom:20px; }
.fix_bottom_wrap.inner .fix_bottom_area ul.large li:nth-child(11) {position:absolute; left:629px; bottom:72px; }
.fix_bottom_wrap.inner .fix_bottom_area ul.large li:nth-child(12) {position:absolute; left:629px; bottom:20px; }


.fix_bottom_wrap.inner .fix_bottom_area ul.small {width:180px; float:left;}
.fix_bottom_wrap.inner .fix_bottom_area ul.small + ul.small {width:110px; }
.fix_bottom_wrap.inner .fix_bottom_area ul.small li {display:block; width:100%;margin-top:10px;}
...
.fix_bottom_wrap.scroll ul li {float:none;display:inline-block;height:38px; line-height:38px;margin:0 2px;padding:0 10px;vertical-align: middle;width:80px; word-break:break-all; }
.fix_bottom_wrap.inner .fix_bottom_area ul.large li:nth-child(2) {width:180px; margin-left:0;}
...
@media screen and (max-width: 1720px) { 
    ...
    .fix_bottom_wrap.scroll ul li:nth-child(2) {width:123px;}
    .fix_bottom_wrap.scroll ul li:nth-child(3) {width:123px;}

    .fix_bottom_wrap.scroll ul.small li:nth-child(2) {width:130px;}
    .fix_bottom_wrap.scroll ul.small li:nth-child(3) {width:130px;}
            ...
            <div class="fix_bottom_wrap scroll">
                <div class="fix_bottom_area">
                    <ul class="large">
                        ...
                        <li style="display:none;"><a class="fix_C13" href="" target=""><em></em></a></li>
