								...
								<form name="form_proc_my_univ" id="form_proc_my_univ" method="post" action="">
									...
									<div class="inner" style="padding-top:157px;">
										...
										<div class="apply_content01" id="info_step1">
											<div class="teamplay_img_wrap">
												<img src="<%=Application("img_path")%>/library/campus_common/2024/2024_teamplay_step/apply_title01.png" alt="수능 성적표"/>
											</div>
											<%
												'수능 성적 파일 가져오기 S
												strSql = ""
										...
										<div class="apply_content02" id="info_step2">
											<div class="img_wrap" style="margin-top:90px;">
												<img src="<%=Application("img_path")%>/library/campus_common/2024/2024_teamplay_step/apply_title02.png" alt="증명사진"/>
											</div>
										...
										<div class="apply_content03" id="info_step3">
											...
											<div class="img_wrap" style="margin-top:90px;">
												<img src="<%=Application("img_path")%>/library/campus_common/2024/2024_teamplay_step/apply_title03.png" alt="합격수기"/>
											</div>
															...
															<div class="textarea_box" style="margin-top:40px;">
																...
																<%If questionIndex = 2 Then '2번째 문항이 '덕분에' 문항%>
																	<div class="img_wrap" style="padding-bottom:20px;">
																		<img src="<%=Application("img_path")%>/library/campus_common/2024/2024_teamplay_step/apply_con03_txt01.png" alt=""/>
																	</div>
									...
									<div class="bg" id="info_step4">
										<div class="inner" style="padding-top:298px;">
											...
											<h4 class="mt85">개인정보 수집 및 이용 동의
												<p class="check fr">
													<input name="Private_All_Agree" id="Private_All_Agree" type="checkbox" value="Y" onclick="Private_All_AgreeFN();">
													<label for="Private_All_Agree"></label>
												</p>
											</h4>
											<div class="ag_box">
												<ul class="list_txt">
													<li>1. 수집 목적 : 장학생 선발에 따른 자격 및 본인확인, 장학생과 연락, 장학생 관리</li>
													<li>2. 수집 및 이용 항목 :<br>
														<span style="padding-left: 13px;">성명, 생년월일, 전화번호(자택, 휴대전화), 사진, 이메일, 출신고 및 계열정보, 성적정보(<%=Right(g_TP_PREV_YEAR, 2)%>년 6월, 9월 평가원 모의고사,</span><br>
														<span style="padding-left: 13px;">수능 등 기타 성적에 관련 사항), 진학대학 및 학과/학번, 예금주명 및 계좌번호(통장사본 포함), 대학 합격 증명서 등 정보</span>
													</li>
													<li>3. 보유기간 : 동의일로부터 5년</li>
												</ul>
											</div>
											<ul class="radio_list taR">
												<li class="radio">
													<input type="radio" class="mt5" name="private_info_agree1" id="private_info_agree12" checked value="Y" onclick="Private_AgreeFN('Y');">
													<label for="private_info_agree12">동의함</label>
												</li>
												<li class="radio">
													<input type="radio" class="mt5" name="private_info_agree1" id="private_info_agree11" checked value="N" onclick="Private_AgreeFN('N');">
													<label for="private_info_agree11">동의안함</label>
												</li>
											</ul>

											<h4 class="mt70">마케팅 활용(사진 및 영상 사용) 동의</h4>
											<div class="ag_box">
												<ul class="list_txt">
													<li>1. 수집 목적 : <strong>메가스터디교육㈜의 각종 홍보&middot;마케팅(홈페이지 &middot; 공식블로그/유튜브, 브랜드북 &middot; 소속학원 내 게시 &middot; 설명회 등)에 활용</strong></li>
													<li>2. 개인정보 수집 및 이용 항목 : <br>
														<span style="padding-left:15px;">성명, 출신고 및 계열정보, 성적정보(<%=Right(g_TP_PREV_YEAR, 2)%>년 6월, 9월 평가원 모의고사, 수능 등 기타 성적에 관련 사항), 진학대학 및 학과, 합격수기, </span><br>
														<span style="padding-left:15px;">메가스터디교육㈜에서 촬영한 장학생의 사진(초상 등) 및 인터뷰 영상 </span>
													</li>
													<li>3. 보유기간 : 동의일로부터 5년</li>
												</ul>
											</div>
											<ul class="radio_list taR">
												<li class="radio">
													<input type="radio" class="mt5" name="private_info_agree2" id="private_info_agree22" checked value="Y" onclick="Private_AgreeFN('Y');">
													<label for="private_info_agree22">동의함</label>
												</li>
												<li class="radio">
													<input type="radio" class="mt5" name="private_info_agree2" id="private_info_agree21" checked value="N" onclick="Private_AgreeFN('N');">
													<label for="private_info_agree21">동의안함</label>
												</li>
											</ul>
										</div>
									</div>
