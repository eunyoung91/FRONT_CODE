            ...
            <div id="div_full" class="div_con">
                ...
                <div class="sector_care">
                    <div class="inner">
                        ...
                        <div class="mt65">
                            <div class="care_graph" style="background:url('<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/care_bg.jpg') 50% top no-repeat;height:822px;">
                                <div>
                                    <img class="vertex" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="500" src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/vertex1.png" alt="" />
                                    <img class="vertex" data-aos="zoom-in" data-aos-delay="300" data-aos-duration="500" src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/vertex2.png" alt="" />
                                    <img class="vertex" data-aos="zoom-in" data-aos-delay="400" data-aos-duration="500" src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/vertex3.png" alt="" />
                                    <img class="vertex" data-aos="zoom-in" data-aos-delay="500" data-aos-duration="500" src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/vertex4.png" alt="" />
                                    <img class="vertex" data-aos="zoom-in" data-aos-delay="600" data-aos-duration="500" src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/vertex5.png" alt="" />
                ...
                <div class="sector_data" style="background:#f1f1f1 url('<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/data_bg.jpg') 50% top no-repeat; background-size:cover;">
                    <div class="inner">
                        ...
                        <div class="title_wrap pt100">
                            ...
                            <div class="title_3">
                                <img data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-delay="300" data-aos-duration="400" src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/data_sub_title.png" alt="" />
                            </div>
                        </div>
                        ...
                        <div class="mt80">
                            <ul class="box_act">
                                <li class="card">
                                    <div class="flipper">                                 
                                        <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/card01.png" alt="" class="front">
                                        <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/card01_on.png" alt="" class="back">
                                    </div>
                                </li>
                                <li class="card">
                                    <div class="flipper">                                 
                                        <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/card02.png" alt="" class="front">
                                        <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/card02_on.png" alt="" class="back">
                                    </div>
                                </li>
                                <li class="card">
                                    <div class="flipper">                                 
                                        <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/card03.png" alt="" class="front">
                                        <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/card03_on.png" alt="" class="back">
                                    </div>
                                </li>
                                <li class="card">
                                    <div class="flipper">                                 
                                        <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/card04.png" alt="" class="front">
                                        <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/card04_on.png" alt="" class="back">
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="sector_solution">
                    <div class="inner">
                        ...
                        <div class="graph_box">
                            <div class="inner">
                                <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/solution_img01.jpg" alt="" />
                                <span class="motion m1"><img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/obj1.png" alt="2023 수능" /></span>
                                <span class="motion m2"><img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/obj2.png" alt="화살표" /></span>
                                <span class="motion m3"><img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/obj3.png" alt="2024 수능" /></span>
                            </div>
                        </div>

                        <div class="how_box">
                            <div>
                                <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/how_img_01.png" alt="" />
                            </div>
                            <div class="mt30">
                                <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/how_img_02.png" alt="" />
                            </div>
                            <div class="mt30">
                                <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/how_img_03.png" alt="" />
                                <div class="slider_wrap">
                                    <div class="slider how_slider">
                                        <div><img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/how_img_03_1.png" alt="" border="0" /></div>
                                        <div><img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/how_img_03_2.png" alt="" border="0" /></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="inner">
                        ...
                        <div class="slider_wrap mt80">
                            <div class="slider con_slider">
                                <div><img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/slide_img01.png" alt="" border="0" /></div>
                                <div><img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/slide_img02.png" alt="" border="0" /></div>
                                <div><img src="<%=Application("img_path")%>/library/campus_common/2024/2024_smart_report/slide_img03.png" alt="" border="0" /></div>
                            </div>
                        </div>
                    </div>
                </div>
