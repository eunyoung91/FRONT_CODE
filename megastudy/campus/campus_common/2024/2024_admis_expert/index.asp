        ...
        <div id="div_cont">
            <div id="div_full" class="div_con">
                ...
                <div class="sector_solution">
                    <div class="inner">
                        ...
                        <div class="title_box pt100">
                            <img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/solution_title.png" alt="메가스터디학원 입시 솔루션" />
                        </div>

                       <div class="student_box mt80">
                            <div class="student_info">
                                <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/sola_img01.jpg" alt="A 학생정보" />

                                <img class="sol_arrow" data-aos="fade-right" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/sol_arrow.png" alt="화살표" />
                                <img class="sol_name" data-aos="fade-right" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/sol_a.png" alt="A학생" />
                            </div>
                            <div class="student_tbl wide">
                                <h4 class="lec_sub_title">전교과 내신 성적</h4>
                                <div class="tbl_cont">
                                    <table cellspacing="0" cellpadding="0" border="0" class="lec_info_tstyle4">
                                        <caption>전교과 내신 성적</caption>
                                        <colgroup>
                                ...
                                <h4 class="lec_sub_title mt60">수능 성적</h4>
                                <div class="tbl_cont">
                                    <table cellspacing="0" cellpadding="0" border="0" class="lec_info_tstyle4">
                                        <caption>수능 성적</caption>
                                        <colgroup>
                                            <col width="20%" span="1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>5등급</td>
                                                <td>1등급</td>
                                                <td class="bgORG">4개 등급 합 <strong>12</strong></td>
                                            </tr>
                                            <tr>
                                                <th>6월 모평</th>
                                                <td>2등급</td>
                                                ...
                                                <td>3등급</td>
                                                <td>1등급</td>
                                                <td class="bgBLUE">4개 등급 합 <strong>8</strong></td>
                                            </tr>
                                            <tr>
                                                <th>9월 모평</th>
                                                <td>2등급</td>
                                                ...
                                                <td>2등급</td>
                                                <td>1등급</td>
                                                <td class="bgBLUE">4개 등급 합 <strong>9</strong></td>
                                            </tr>
                                            <tr>
                                                <th>2024학년도 수능</th>
                                                <td>2등급</td>
                            ...
                            <div class="student_sol mt70">
                                <img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/sola_sub.png" alt="메가스터디학원의 솔루션" />
                                <img class="sol_line" data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/sol_line.png" alt="메가스터디학원의 솔루션" />

                                <img class="sol_trophy" data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/sola_trophy.jpg" alt="메가스터디학원의 솔루션" />
                                <img class="sol_type" data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/sola_type.png" alt="고려대 학업우수형 최종합격" />
                            </div>
                        </div>

                        <div class="student_box mt100">
                            <div class="student_info">
                                <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/solb_img01.jpg" alt="B 학생정보" />

                                <img class="sol_arrow" data-aos="fade-right" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/sol_arrow.png" alt="화살표" />
                                <img class="sol_name" data-aos="fade-in" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/sol_b.png" alt="A학생" />
                            </div>
                            <div class="student_tbl wide">

                                <h4 class="lec_sub_title mt60">수능 국어 과목 성적</h4>
                                <div class="tbl_cont">
                                    <table cellspacing="0" cellpadding="0" border="0" class="lec_info_tstyle4">
                                        <caption>수능 국어 과목 성적</caption>
                                        <colgroup>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>과목</th>
                                                <td class="bgORG">화법과작문</td>
                                                <td class="bgBLUE">언어와매체</td>
                                                <td class="bgBLUE">언어와매체</td>
                                                <td class="bgBLUE">언어와매체</td>
                                                <td class="bgBLUE">언어와매체</td>
                                            </tr>
                            ...
                            <div class="student_sol mt70">
                                <img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/solb_sub.png" alt="메가스터디학원의 솔루션" />
                                <img class="sol_line" data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/sol_line.png" alt="메가스터디학원의 솔루션" />

                                <img class="sol_trophy" data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/solb_trophy.jpg" alt="메가스터디학원의 솔루션" />
                                <img class="sol_type" data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/solb_type.png" alt="고려대 정시 최종지원" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sector_differ" style="background:#1e1e1e url('<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_bg.jpg') 50% top no-repeat;background-size:cover;">
                    <div class="inner">
                        <div class="title_box pt100">
                            <img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_title.png" alt="입시 전문가는 다릅니다!" />
                        </div>
                        <div class="differ_graph">
                            <img class="dif_left" data-aos="fade-left" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_left.png" alt="전형별 전문 교육 시행" />

                            <img src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_center.png" alt="입시 전문가" />

                            <img class="dif_right" data-aos="fade-right" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_right.png" alt="전문 평가 시스템" />
                        </div>
                        <div class="differ_pic">
                            <img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_img01.png" alt="시험장 사진" />
                        </div>
                        <div class="differ_circle">
                            <img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_img02.png" alt="재원생들의 입시,학습을 책임집니다." />
                        </div>
                        <div class="differ_curri">
                            <img class="curri_end" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_end.png" alt="대입성공 커리" />
                            <div class="point">
                                <img class="point_1" data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_curri1.png" alt="2월" />
                                <img class="point_2" data-aos="fade-down" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_curri2.png" alt="4월" />
                                <img class="point_3" data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_curri3.png" alt="5월" />
                                <img class="point_4" data-aos="fade-down" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_curri4.png" alt="7월" />
                                <img class="point_5" data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_curri5.png" alt="10월" />
                                <img class="point_6" data-aos="fade-down" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/differ_curri6.png" alt="12월" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sector_review">
                    <div class="inner">
                        <div class="title_box pt100">
                            <img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/review_title.png" alt="입시 전문가는 우수합니다!" />
                        </div>
                        <div class="review_box">
                            <div><img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/review_img01.png" alt="리뷰1" /></div>
                            <div><img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/review_img02.png" alt="리뷰2" /></div>
                            <div><img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/review_img03.png" alt="리뷰3" /></div>
                            <div><img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/review_img04.png" alt="리뷰4" /></div>
                            <div><img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/review_img05.png" alt="리뷰5" /></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sector_expert">
                    <div class="inner">
                        <div class="title_box pt100">
                            <img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/expert_title.png" alt="입시 전문가를 소개합니다." />
                        </div>
                    </div>
                ...
                <div class="sector_banner" style="background:#1e1e1e url('<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/banner_bg.jpg') 50% top no-repeat;">
                    <div class="inner">
                        <img data-aos="fade-up" src="<%=Application("img_path")%>/library/campus_common/2024/2024_admis_expert/banner_title.png" alt="메가스터디 입시 전문가가 함께 합니다." />
                    </div>
                </div>
            </div>
        </div>
