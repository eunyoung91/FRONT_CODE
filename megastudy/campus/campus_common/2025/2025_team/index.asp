...
<head>
	...
	<style type="text/css">
		...
		.top_wrap .rolling .vertical .scholarship_wrap {width:1100px; padding-top:95px;}
		...
		.top_wrap .rolling .vertical .scholarship_banner div {display:inline-block; position:relative; overflow:hidden; width:275px; text-align:right; margin-left:100px;}
		...
		.div_con1 .con {height:338px;padding-left: 14px; background:url('<%=Application("img_path")%>/library/campus_common/2025/2025_team/count_bg_1.jpg') 50% 0 no-repeat; position:relative;}
		.div_con1 .con .counter {font-size:66px; font-weight:bold; position:absolute; top:170px; color:#000;}
		.div_con1 .con .counter.posi01 {left:170px;}
		.div_con1 .con .counter.posi02 {left:670px;} 

		.div_con2 { position: relative; overflow: hidden; background-color:#f4ebd7; text-align: center; padding-bottom: 100px; font-family: "Pretendard Variable";}
		...
		.div_con3 ul li .team_contents {font-weight:normal; font-size:15px; line-height:25px; color:#777; padding:0 40px;}
		...
		#div_cont { width: 100%; font-size: 16px; font-family: "Pretendard Variable"; line-height: 1.2; letter-spacing: -1.5px; color: #333; text-align: center; clear: both; position: relative; overflow: hidden; } 
	</style>
</head>
<body>
	<div id="wrapper">
