...
.seg_visual .motion._02{bottom:-440px;left:50%; transform: translateX(-50%);}
...
.seg_cnt3{background-color:#eee;}
.seg_cnt3 .btn{position:absolute;top:557px;}
.seg_cnt3 .btn._01{left:39px;}
.seg_cnt3 .btn._02{left:381px;}
...
.seg_cnt6 .inner_slider .slider__label{position:absolute;height:7px;background-color:#1fc1cf;border-radius:4px;box-sizing:border-box;transition:0.5s linear;}
            ...
            <div id="div_full" class="div_con">
				<div class="seg_visual">
					<div class="cnt cnt_ect">
						...
						<img src="<%=Application("img_path")%>/library/campus_common/2020_weekplanner/main_planner.png" alt="" class="motion _02">
					</div>
				</div>
				<div class="seg_cnt1">
					<div class="cnt">
				...
				<div class="seg_cnt2">
					<div class="cnt">
						<img src="<%=Application("img_path")%>/library/campus_common/2020_weekplanner/cnt2.jpg" alt="">
					</div>
				</div>
				<div class="seg_cnt3">
					<div class="cnt">
						<img src="<%=Application("img_path")%>/library/campus_common/2019_weekplanner/cnt3.jpg" alt="" >
						<a href="#_01" class="btn _01"><img src="<%=Application("img_path")%>/library/campus_common/2019_weekplanner/cnt3_btn01.jpg" alt="" ></a>
						<a href="#_02" class="btn _02"><img src="<%=Application("img_path")%>/library/campus_common/2019_weekplanner/cnt3_btn02.jpg" alt="" ></a>
						<a href="#_03" class="btn _03"><img src="<%=Application("img_path")%>/library/campus_common/2019_weekplanner/cnt3_btn03.jpg" alt="" ></a>
					</div>
					<!-- 레이어팝업영역 -->
					<div class="wrap_pop">
						<div class="inner_pop _01" id="_01">
							<div class="pop_slide">
								...
								<div><img src="<%=Application("img_path")%>/library/campus_common/2019_weekplanner/cnt3_slider01_slide02.jpg" alt="" /></div>
						...
						<div class="inner_pop _03" id="_03">
							<div class="pop_slide">
								<div><img src="<%=Application("img_path")%>/library/campus_common/2019_weekplanner/cnt3_slider03_slide01.jpg" alt="" /></div>
				...
				<div class="seg_cnt5">
					<div class="cnt" style="padding-bottom:50px;">
						<img src="<%=Application("img_path")%>/library/campus_common/2020_weekplanner/cnt5.jpg" alt="">
					</div>
				</div>
				<div class="seg_cnt6">
					<div class="cnt">
...
<!-- 
 ...
 -->
    ...
    motion.to(".motion._02", 1, {delay:0.5, opacity:1, bottom:-20, ease: Expo.easeOut}).to(".motion._01", 1, {delay:-0.5, opacity:1, top:100, ease: Expo.easeOut})
