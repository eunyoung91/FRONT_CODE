...
.seg_visual .motion._02{bottom:-440px;left:48.5%; transform: translateX(-50%);margin-left:20px;}
            ...
            <div id="div_full" class="div_con">
				<div class="seg_visual">
					<div class="cnt cnt_ect">
						...
						<img src="<%=Application("img_path")%>/library/campus_common/2024/2024_weekplanner_2/main_planner_241203.png" alt="" class="motion _02">
					</div>
				</div> 
				<div class="seg_cnt1">
					<div class="cnt">
				...
				<div class="seg_cnt2">
					<div class="cnt">
						<img src="<%=Application("img_path")%>/library/campus_common/2024/2024_weekplanner_2/cnt2_241203.png" alt="">
					</div>
				</div>
				<div class="seg_cnt3">
					<div class="cnt">
				...
				<div class="seg_cnt5">
					<div class="cnt">
						...
						<img class="mt70" src="<%=Application("img_path")%>/library/campus_common/2024/2024_weekplanner_2/cnt5_02.png" alt="">
					</div>
				</div>
				<div class="seg_cnt6">
					<div class="cnt">
...
<!-- 
 ...
 -->
    ...
    motion.to(".motion._02", 1, {delay:0.5, opacity:1, bottom:-180, ease: Expo.easeOut})
	      .to(".motion._01", 1, {delay:-0.5, opacity:1, top:100, ease: Expo.easeOut})
