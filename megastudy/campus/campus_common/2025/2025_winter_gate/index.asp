        ...
        <ul class="quick">
            <li>
                <a href="https://campus.megastudy.net/common/notice/fair_view.asp?code=25038" target="_blank">
                    <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/quick_link.png" alt="윈터스쿨 설명회">
                </a>
            </li>
            <li>
                <a href="#sectionTitle">
                    <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/btn_quick_top.png" alt="top으로 이동">
                </a>
            </li>
        </ul>
    <%
    ...
    %>
        ...
        <div id="contents">
            <div class="section_title" id="sectionTitle" style="background:url('<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_bg.jpg') 50% top no-repeat;">
                <div class="wrap_full">
                    <div class="act_wrap">
                        <img class="txt act01_1" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_txt01_1.png" alt="습관" />
                        <img class="txt act01_2" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_txt01_2.png" alt="을 잡으면" />
                        <img class="txt act01_3" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_txt01_3.png" alt="성적" />
                        <img class="txt act01_4" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_txt01_4.png" alt="이 잡힌다!" />
                        <img class="txt act02" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_txt02.png" alt="2025" />
                        <img class="txt act03_1" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_txt03_1.png" alt="원" /> 
                        <img class="txt act03_2" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_txt03_2.png" alt="터" /> 
                        <img class="txt act03_3" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_txt03_3.png" alt="스" /> 
                        <img class="txt act03_4" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_txt03_4.png" alt="쿨" />

                        <div class="txt act04">
                            <!-- <div>
                                <img class="" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_txt04_1.png" alt="기숙" />
                                <span><em class="num">2025. 1. 1</em>(수) 개강</span>
                            </div>
                            <div>
                                <img class="" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/top_txt04_2.png" alt="통학" />
                                <span><em class="num">2025. 1. 2</em>(목) 개강</span>
                            </div> -->
                            <div>
                                <span><em class="num"> 2025. 1. 2</em>(목) 개강</span>
                            </div> 
            ...
            <div class="winter_course1">
                <div class="wrap">
                    <div class="ani_element b_to_t delay500">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course1_tit.png" alt="체계적인 프로그램으로 확실한 실력 향상!" />
                    </div>
                    <div class="ani_element b_to_t mt45 delay500">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course1_img1.jpg" alt="서울대 의예과 합격생이 인정한 관리력" />
                    </div>
                    <div class="ani_element b_to_t mt100 delay500">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course1_sub_tit.png" alt="전문가 그룹의 검증된 관리력 메가멘토" />
                    </div>
                    <div class="winter_mento mt60">
                        <img class="ani_element b_to_t delay300" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/mento_img01.png" alt="학습멘토" />
                        <img class="ani_element b_to_t delay500" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/mento_img02.png" alt="입시멘토" />
                        <img class="ani_element b_to_t delay700" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/mento_img03.png" alt="생활멘토" />
                    </div>
                </div>                    
            </div>
            ...
            <div class="winter_course2">
                <div class="wrap">
                    <div class="ani_element b_to_t">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course2_tit.png" alt="체계적인 프로그램으로 확실한 실력 향상!" />
                    </div>
                    <div class="ani_element b_to_t mt100">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course2_sub_tit1.png" alt="수강생의 높은 만족도 기록!" />
                    </div>
                    <div class="winter_survey mt60">
                        <img class="ani_element b_to_t delay200" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course2_img1.png" alt="2024 윈터스쿨 만족도 조사 결과1" />
                        <img class="ani_element b_to_t delay300" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course2_img2.png" alt="2024 윈터스쿨 만족도 조사 결과2" />
                        <img class="ani_element b_to_t delay400" src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course2_img3.png" alt="2024 윈터스쿨 만족도 조사 결과3" />
                    </div>
                    <div class="ani_element b_to_t delay500 mt40">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course2_txt.png" alt="2024 윈터스쿨 수강생 만족도 조사 결과(만족 계열 의견 합산)" />
                    </div>
                    <div class="ani_element b_to_t mt100 delay500">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course2_sub_tit2.png" alt="차별화된 윈터스쿨 프로그램" />
                    </div>
                    ...
                    <div class="ani_element b_to_t delay500 mt80">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course2_sub_tit3.png" alt="고품격 윈터스쿨 학습 콘텐츠" />
                    </div>
                    <div class="slide_area ani_element b_to_t delay600 mt60">
                        <div class="slick_wrap">
                            <ul class="slick_slider">
                              <li class="slick_card"><img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/contents_slide01.png" alt="수학 아이젠" /></li>
                              <li class="slick_card"><img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/contents_slide02.png" alt="실전 모의고사" /></li>
                            </ul>
                        </div>
                    </div>
                    <script>
                        $('.slick_slider').slick({
                            ...
                            customPaging: function (slider, i) {
                                ...
                                if (i == '0') {
                                i = "수학 집중 관리 프로그램<strong>수학 아이젠</strong>";
                                } else if (i == '1') {
                                i = "겨울방학 최종 마무리<strong>윈터스쿨 실전 모의고사</strong>";
                                }
                    ...
                    <div class="ani_element b_to_t delay600 mt40">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course2_txt1.png" alt="※ 유료로 판매되는 콘텐츠로 학원별로 진행 여부 및 진행 방식이 상이할 수 있습니다." />
                    </div>
                </div>                    
            </div>
            ...
            <div class="winter_course3">
                <div class="wrap">
                    <div class="ani_element b_to_t">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course3_tit.png" alt="체계적인 프로그램으로 확실한 실력 향상!" />
                    </div>
                    <div class="ani_element b_to_t mt100">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/course3_sub_tit1.png" alt="3단계 선순환 시스템" />
                    </div>
            ...
            <div class="winter_review">
                <div class="wrap">
                    <div class="ani_element b_to_t">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/review_tit.png" alt="도약에 성공한 선배들의 리얼후기" />
                    </div>
            ...
            <div class="winter_link_list" id="link" style="padding-top:100px; background:url('<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/link_bg.jpg') 50% top no-repeat;background-size:cover;">
                <div class="wrap">
                    <div class="ani_element b_to_t">
                        <img src="<%=Application("img_path")%>/library/campus_common/2025/2025_winter_gate/link_title.png" alt="학원별 모집안내" />
                    </div>
