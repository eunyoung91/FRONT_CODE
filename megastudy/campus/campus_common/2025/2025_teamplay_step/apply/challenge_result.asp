																...
																<td>
																	<div class="input_file univ">
																		...
																		<%
																			...
																			' If CDbl("2025"&"0102"&"100000") <= CDbl(GetNowDate()) And CDbl(GetNowDate()) <= CDbl("2025"&"0106"&"100000") Then
																			' 	passUnivType = "susi"  - 2025 팀플장학은 수시 지원 기간이 의미가 없음. 
																			
																			If  CSTr(GetServerGubun()) = "dev" OR (CDbl("2025"&"0106"&"100000") <= CDbl(GetNowDate()) And CDbl(GetNowDate()) <= CDbl("2025"&"0228"&"235959")) Then
															...
															<tr>
																...
																<td class="taL">
																	<%
																		...
																		strSql = strSql & vbcrlf & "	, dbo.UF_GET_Decode(TP_MEMBANK_NUM) AS TP_MEMBANK_NUM"
																		strSql = strSql & vbcrlf & "FROM"
																		strSql = strSql & vbcrlf & "	AMS_TEAMPLAY_EVT"
																		strSql = strSql & vbcrlf & "WHERE"
																		strSql = strSql & vbcrlf & "	TP_TYPE = 'F'"
