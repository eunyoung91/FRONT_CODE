		...
		<div id="omegaWrap" class="omega-wrap">
			...
			<script>
				function openOmegaPopup() {
					...
					window.open(
						'https://campus.megastudy.net/campus_common/2025/2025_omega/popup.asp?pagetype=C', 
						'popup', 
			...
			<div class="omega-popup">
				<img src="<%=Application("img_path")%>/library/campus_common/2025/2025_omega/omega_quickbanner.png" alt="배너 이미지" onclick="openOmegaPopup()">
			</div>
			<!-- openOmegaPopup -->
			...
			<div class="cont01 js-cont">
				<div class="inner">
					<div class="img_wrap">
						<img src="<%=Application("img_path")%>/library/campus_common/2025/2025_omega/250326/cont01.jpg" alt="검증된 7단계 출제·검수 시스템" />
					</div>
				</div>
			</div>
			...
			<div class="cont02 js-cont"> 
				<div class="inner">
					<div class="img_wrap">
						<img src="<%=Application("img_path")%>/library/campus_common/2025/2025_omega/250326/cont02.jpg" alt="'맞춤' 모의고사" />
					</div>
				</div>
			</div>
			...
			<div class="cont js-cont-wrap cont-bg-box">
				<div class="cont03 js-cont">
					...
					<div class="inner">
						<div class="img_wrap">
							<img src="<%=Application("img_path")%>/library/campus_common/2025/2025_omega/250326/cont03.png" alt="OMEGA 실전 대비 모의고사·복습 SET" />
						</div>
					</div>
				</div>
				...
				<div class="cont04 js-cont">
					<div class="inner">
						<div class="slide-wrap">
							<p class="tit">
								<img src="<%=Application("img_path")%>/library/campus_common/2025/2025_omega/250326/cont04.png" alt="OMEGA" />
							</p>
							<ul class="sl-box">
				...
				<div class="cont05 js-cont">
					<div class="inner">
						<div class="slide-wrap">
							<p class="tit">
								<img src="<%=Application("img_path")%>/library/campus_common/2025/2025_omega/250326/cont05.png" alt="OMEGA link" />
							</p>
							<ul class="sl-box">
								<li class="slide01 active">
			...
			<div class="cont js-cont-wrap">
				<div class="cont06">
					<div class="inner">
						...
						<div class="img_wrap">
							<img src="<%=Application("img_path")%>/library/campus_common/2025/2025_omega/250326/cont06.png" alt="OMEGA black / OMEGA blue" />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="cont js-cont-wrap">
				<div class="cont07">
					<div class="inner">
						<div class="slide-wrap">
							<p class="tit">
								<img src="<%=Application("img_path")%>/library/campus_common/2025/2025_omega/250326/cont07_tit.png" alt="실전형 습관 100% 완성 주간 미니 모의고사" />
							</p>
							<div class="img_wrap">
								<img src="<%=Application("img_path")%>/library/campus_common/2025/2025_omega/250326/cont07.png" alt="OMEGA weekly" />
							</div>
							<ul>
								<li class="slide01 active">
